...
<template>
  <section id="contact-me" class="bg-tertiary pt-16 xl:pt-20">
    <TheContainer>
      <div
        class="flex flex-col items-center border-b border-b-grayish pb-[90px] xl:flex-row xl:items-start xl:justify-between"
      >
